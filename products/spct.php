                                ...
                                <div class="col l-6">
                                    ...
                                    <div class="slider-pro">
                                        ...
                                        <div class="slider-pro__item">
                                            <a href="../assect/img/product/<?php echo $img;?>" class="slider-pro__link"
                                                data-fancybox="group" data-fancbox-group="group" rel="group">
                                                <img src="../assect/img/product/<?php echo $img;?>" alt=""
                                        ...
                                        <!-- <div class="list-image ">
                                            <div class="l-3">
                                                <img src="../assect/img/product/quần/SCRO-1.webp" alt="" class="list-image_sm">
                                            </div>
                                            
                                            <div class="l-3">
                                                <img src="../assect/img/product/quần/SCRO-2.jpeg" alt="" class="list-image_sm">
                                            </div>
                                                ...
                                                <form action="addcart.php" method="post">
                                                    ...
                                                    <div class="qty-cart">
                                                        <div class="qty-cart__table ">
                                                            ...
                                                            <div class="pro-size" style="display:table;clear:both">
                                                                <div id="variant-swatch-0" class="swatch clearfix">
                                                                    <div class="header-s">Kích thước</div>
                                                                    <div class="select-swap" id="select-swap">
            
            
            
                                                                        <div data-value="M" class="n-sd swatch-element m ">
                                                                            <input class="variant-0" id="swatch-0-m" type="radio" name="gender" value="M" checked="">
                                                                                
            
                                                                            <label for="swatch-0-m" class="select-label">
                                                                                M
                                                                                <!-- <img class="crossed-out" src="//theme.hstatic.net/1000348721/1000449307/14/sold.png?v=531"> -->
            
                                                                                <!-- <img class="img-check" src="//theme.hstatic.net/1000348721/1000449307/14/select-pro.png?v=531"> -->
                                                                            </label>
                                                                        ...
                                                                        <div data-value="L" class="n-sd swatch-element l ">
                                                                            <input class="variant-0" id="swatch-0-l" type="radio" name="gender" value="L"  >
                                                                                
            
                                                                            <label for="swatch-0-l" class="select-label">
                                                                                L
                                                                                <!-- <img class="crossed-out" src="//theme.hstatic.net/1000348721/1000449307/14/sold.png?v=531"> -->
                                                        ...
                                                        <div class="link-detail ">
                                                            <button href="" class="add-cart" name="addcart" id="add" >
                                                                Thêm vào giỏ hàng
                                                            </button>
                                                        </div>
