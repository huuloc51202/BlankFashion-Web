                                ...
                                <div class="col l-6">
                                    <div class="slider-pro">
                                        ...
                                        <div class="slider-pro__item">
                                            <a href="../assect/img/lookbook/aefit_1.webp" class="slider-pro__link"
                                                data-fancybox="group" data-fancbox-group="group" rel="group">
                                                <img src="../assect/img/lookbook/aefit_1.webp" alt=""
                                        ...
                                        <div class="list-image ">
                                            <div class="l-3">
                                                <img src="../assect/img/lookbook/aefit_1.webp" alt="" class="list-image_sm">
                                            </div>
                                            
                                            <div class="l-3">
                                                <img src="../assect/img/lookbook/new1.webp" alt="" class="list-image_sm">
                                            </div>
                                            ...
                                            <div class="qty-cart__table ">
                                                ...
                                                <div class="table-share table-qty">
                                                    <div class="qty-number" id="buy-amount">
                                                        ...
                                                        <input type="text"   name="quantity" min="1" id="amount" value="1" class="item-quantity ">
                                                ...
                                                <div class="pro-size" style="display:table;clear:both">
                                                    <div id="variant-swatch-0" class="swatch clearfix">
                                                        ...
                                                        <form class="select-swap" id="select-swap">
