    ...
    <script>
        var arrPro = [
...

            {
                tenSP : 'Quần SCRO' ,
                giaSP : 720000 ,
                imgSP : './assect/img/product/quần/SCRO-1.webp',
                imgSP2 : './assect/img/product/quần/SCRO-2.jpeg',
                linkSP : './products/scro.php'
            },

            {
                tenSP : 'Áo RABBIT' ,
                giaSP : 1520000 ,
                imgSP : './assect/img/lookbook/rabbit.webp',
                imgSP2 : './assect/img/lookbook/rabbit2.webp',
                linkSP : './products/rabbit.php'
            },
        ];
