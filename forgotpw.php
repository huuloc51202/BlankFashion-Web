<?php
    ...
    if (isset($_POST['submit'])&&isset($_POST['submit'])) {
        ...
        function checkemail($email){
            ...
            $sql="SELECT * FROM `res-user` WHERE `email`='$email' ";
        ...
        if(is_array($checkemail)){
            $message = "Mật khẩu của bạn là:".$checkemail['password'];
...
<head>
    ...
    <title>Quên mật khẩu - BLANKSOUL</title>
                    ...
                    <div class="new-login" > 
                        ...
                        <div class="box-login">
                            <form id="form-1"   method="post"  onsubmit="this.form.submit()" >
                                <h4 class="login-custumer">Quên mật khẩu</h4>
                                ...
                                <button type="submit" name="submit" class="pagination-item__btn ">Lấy mật khẩu</button>

                               

                                <div  class="forgot"> 
                                    <a href="login.php" class="forgot-pw">Đăng nhập</a> hoặc 
