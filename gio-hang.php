            ...
            <div class="grid wide" >
                <div class="col">
                    <div class="new-product" > 
                        <!-- header-body  -->
                        <div class="l-12">
                            <div class="cart-titlet ">
                                <h1 class="titlet">GIỎ HÀNG</h1>
                        ...
                        <div class="product-cart">  
                            <div  class="col l-8" style="padding-left:0px">
                                <div class="table-cart">
                                    <div class="table__product">
                                        <thead>
                                            <div class="table-heading">
                                                <span class="table-share table-product">Sản phẩm</span>
                                                <span class="table-share table-qty">Số lượng</span>
                                                <span class="table-share table-linePrice">Tổng tiền</span>
                                                <span class="table-share table-remove">Xóa</span>
                                            ...
                                            <div id="pro-table">
                                                ...
                                                <?php
                                                    ...
                                                    foreach ($_SESSION['mycart'] as $cart) {
                                                        ...
                                                        $del = '<a href="del.php?idcart='.$i.'"><input type="button" value="xoá"></a>';
                                                        echo '
                                                            <div class="table-heading">
                                                                <input type="hidden" name="" value="'. $cart[2] .'">
                                                                <div class="table-share table-product">
                                                                    <a href="./products/spct.php?id='.$cart[0].'" style="text-decoration:none;">
                                                                        <div class="thumb-cart">
                                                                            <img src="./assect/img/product/'.$cart[1].' " alt="" style="width : 150px; margin-right: 15px;">
                                                                            <div class="thumb-cart__item">
                                                                                <h4> '. $cart[2] .' </h4>
                                                                                <span class="variant-title" > '. $cart[5] .' </span>
                                                                                <span>'. $cart[3] .'₫</span>
                                                                            </div>
                                                                        </div>
                                                                    </a>
                                                                ...
                                                                <div class="table-share table-qty">
                                                                    <div class="qty-number">
                                                                        ...
                                                                        <input type=""   name="quantity" min="1" id="amount" value="'. $cart[4] .'" class="item-quantity " aria-label="quantity">
                                                                        <button onclick="tang(this , `+i+`)"  class="qtyplus">+</button>
                                                                    </div>
                                                                </div>
                                                                <b class="table-share table-linePrice"><span>'. $cart[6] .'</span>₫</b>
                                    ...
                                    <div class="row" style="justify-content:space-around;">
                                        ...
                                        <div class="button-cart">
                                            <a class="cart-continue " onclick="del()" style="cursor : pointer;">  
                                                Xoá tất cả sản phẩm
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <nav class="category">
                                    <div class="cart__total">
                                        <div class="category-total">
                                            ...
                                            <?php
                                                ...
                                                echo '
                                                    <b class="total-cate" id="total-cate">'.$totalcart.'đ</b>
                                                ';
                                            ?>
                                        ...
                                        <div class="button-total">
                                            <a href="thanhtoan.php" class="pay-total">
                                                Thanh toán
                                            </a>
                                        </div>
                                    ...
                                    <div class="cart-note">
                                        <div class="category-note">
                                            <label for="note" class="note-item" >Ghi chú</label>
